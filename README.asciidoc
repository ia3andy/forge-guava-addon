== guice-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The guice-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.ia3andy.forge.addon</groupId>
   <artifactId>guava-addon</artifactId>
